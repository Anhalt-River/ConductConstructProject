...
{
    public class PersonStorageService : IPersonStorageServices
    {
        private readonly IJSRuntime _jsRuntime;

        public PersonStorageService(IJSRuntime jsRuntime)
        {
            _jsRuntime = jsRuntime;
        }

        public async Task SetAsync<T>(string key, Task item) where T : class
        {
